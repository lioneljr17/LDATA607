...
**Insert your answer here**
I simulated 100 flips of an unfair coin where the probability of heads was 0.20 and the probability of tails was 0.80.And  I had got 26 heads and 74 tails
...
The distribution of streak lengths for the simulated independent shooter is also right-skewed. Most streaks are short, with streak lengths of 0 and 1 occurring most frequently. Longer streaks become increasingly rare.
```{r}
...
**Insert your answer here**
I would expect the second simulation to produce a streak distribution that is somewhat similar but not exactly the same. Because the simulation is based on random sampling, each run will generate different sequences of hits and misses.
...
**Insert your answer here**
Kobe Bryant's streak-length distribution appears similar to the distribution produced by the simulated independent shooter. In both cases, short streaks occur most frequently and long streaks are relatively uncommon.
