...
ggplot()+ geom_line(data = wage_by_edu, aes(x = year, y = less_than_hs,color ="Less Than High School")) + 
  ...
  labs(title ="Average Wages By Education level",x ="Years",y="Average wages", color ="Education Level")+
