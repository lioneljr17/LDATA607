...
movie_avrg_row<- data.frame(users_name ="movie_avrg", t(movie_avrg), user_avrg =mean(movie_avrg, na.rm = TRUE), users_bias =NA)
...
movie_bias
movie_bias_row<- data.frame(users_name ="movie_avrg -movies mean", t(movie_bias), user_avrg =NA,users_bias =NA)
