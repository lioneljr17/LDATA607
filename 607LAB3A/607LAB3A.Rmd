...
movie_avrg_row<- data.frame(users_name ="movie_avrg", t(movie_avrg), user_avrg =mean(movie_avrg, na.rm = TRUE), use_bias =NA)

movie_avrg_row

Movie_Rating_view <- bind_rows(Movie_Rating_view,movie_avrg_row)

tail(Movie_Rating_view)
```
```{r movie bias}
